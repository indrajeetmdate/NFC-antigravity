      ...
      <div className="max-w-2xl w-full px-4 -mt-20 md:-mt-24 mb-12 z-10 flex flex-col items-center text-center">
          ...
          <div className="mt-8 w-full max-w-md space-y-4">
             <a 
                ...
                className={`block w-full py-3.5 px-4 font-bold text-center transition-transform hover:scale-[1.02] flex items-center justify-center gap-2 ${mainBtnStyle.shape} ${mainBtnStyle.shadow ? 'shadow-lg' : ''}`}
                style={{
            ...
            {actionButtons.map((btn: CustomButtonElement) => (
                <a
                    ...
                    className={`block w-full py-3 px-4 font-semibold text-center transition-transform hover:scale-[1.02] flex items-center justify-center gap-2 ${btn.style.shape} ${btn.style.shadow ? 'shadow-md' : ''} ${btn.style.border ? 'border border-white/20' : ''}`}
                    style={{
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4 w-full max-w-md">
                  {socialButtons.map((btn: CustomButtonElement) => (
                      <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-12 h-12 rounded-full flex items-center justify-center bg-zinc-800/80 hover:scale-110 transition-all duration-300 shadow-lg"
                          style={{ 
                              backgroundColor: btn.style.backgroundColor,
                              color: btn.style.textColor 
                          }}
