          ...
          <div className="flex flex-col items-center gap-1 opacity-70">
            {profile.gst_number && (
              <div className="flex items-center gap-2">
                <p className="text-[10px] uppercase tracking-wider font-medium">GST No: <span className="text-zinc-400 font-mono select-all">{profile.gst_number}</span></p>
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(profile.gst_number || '');
                    alert("GST Number copied!");
                  }}
            ...
            {profile.billing_address && (
              <div className="max-w-xs mx-auto text-center relative">
                <p className="text-[10px] whitespace-pre-line leading-snug inline select-all">
                  {profile.billing_address}
                </p>
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(profile.billing_address || '');
                    alert("Address copied!");
                  }}
                  className="inline-block ml-1.5 align-text-top text-zinc-500 hover:text-gold transition-colors"
                  title="Copy Address"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
